...
function startElectron() {
    ...
    electronProcess.stdout.on("data", data => electronLog(data, "blue")); // console.log(data.toString())
    electronProcess.stderr.on("data", data => electronLog(data, "red")); // console.error(data.toString())
